...
export const PRICING: Record<string, PricingEntry> = {
  ...
  "Sitaw": { basis: "count", countUnit: "pcs", ratePerUnit: 3, overrides: { bundle: 10 } },
  ...
  "Shrimp": { basis: "count", countUnit: "pcs", ratePerUnit: 8, overrides: { kg: 65, g: 0.065 } },
  ...
  "Tilapia": { basis: "count", countUnit: "pcs", ratePerUnit: 90, overrides: { g: 0.0033 } },
  ...
  // Pricing for the 116-recipe batch's new canonical ingredients.
  "Curry Powder": { basis: "volume", ratePerMl: 0.2 },
  "Honey": { basis: "volume", ratePerMl: 0.4 },
  "Sesame Oil": { basis: "volume", ratePerMl: 0.15 },
  "Sesame Seeds": { basis: "volume", ratePerMl: 0.3 },
  "Green Peas": { basis: "volume", ratePerMl: 0.15 },
  "Coconut Water": { basis: "volume", ratePerMl: 0.06 },
  "Turmeric Powder": { basis: "volume", ratePerMl: 0.15 },
  "Bread Crumbs": { basis: "volume", ratePerMl: 0.05 },
  "Spinach": { basis: "volume", ratePerMl: 0.08 },
  "Langka": { basis: "volume", ratePerMl: 0.08 },
  "Rice": { basis: "volume", ratePerMl: 0.015 },

  "Orange": { basis: "count", countUnit: "pcs", ratePerUnit: 10 },
  "Lemongrass": { basis: "count", countUnit: "pcs", ratePerUnit: 2 },
  "Galunggong": { basis: "count", countUnit: "pcs", ratePerUnit: 15 },
  "Hasa-hasa": { basis: "count", countUnit: "pcs", ratePerUnit: 20 },
  "Broccoli": { basis: "count", countUnit: "pcs", ratePerUnit: 70 },
  "Sayote": { basis: "count", countUnit: "pcs", ratePerUnit: 10 },
  "Upo": { basis: "count", countUnit: "pcs", ratePerUnit: 20 },
  "Patola": { basis: "count", countUnit: "pcs", ratePerUnit: 15 },
  "Kamote Tops": { basis: "count", countUnit: "bundle", ratePerUnit: 15 },
  "Green Mango": { basis: "count", countUnit: "pcs", ratePerUnit: 15 },
  "Tinapa": { basis: "count", countUnit: "pcs", ratePerUnit: 20 },
  "Ham": { basis: "count", countUnit: "slice", ratePerUnit: 8 },
  "Green Onion": { basis: "count", countUnit: "bundle", ratePerUnit: 10 },
  "Salted Egg": { basis: "count", countUnit: "pcs", ratePerUnit: 15 },
  "Sardines": { basis: "count", countUnit: "can", ratePerUnit: 25 },
  "Corned Beef": { basis: "count", countUnit: "can", ratePerUnit: 45 },

  "Beef Tripe": { basis: "weight", ratePerGram: 0.25 },
  "Ground Beef": { basis: "weight", ratePerGram: 0.4 },
  "Mushrooms": { basis: "weight", ratePerGram: 0.15 },
  "Mussels": { basis: "weight", ratePerGram: 0.12 },
  "Tofu": { basis: "weight", ratePerGram: 0.08 },
  "Sotanghon Noodles": { basis: "weight", ratePerGram: 0.15 },
  "Misua Noodles": { basis: "weight", ratePerGram: 0.2 },
  "Lomi Noodles": { basis: "weight", ratePerGram: 0.15 },
  "Miki Noodles": { basis: "weight", ratePerGram: 0.13 },
};
